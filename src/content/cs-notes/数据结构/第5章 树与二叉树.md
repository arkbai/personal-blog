...
3. m叉树：最多有m个结点【分支可以是空树】
	<img src="images/Pasted%20image%2020260423220106.png" width="310">
...
1. 满二叉树：结点为2<sup>h</sup>-1
	- 结点i的左孩子为2i，右孩子为2i+1
2. **完全二叉树**： 
	<img src="images/Pasted%20image%2020260423221358.png" width="202">
3. **二叉排序树**：左<右，O(n)
...
<img src="images/Pasted%20image%2020260423224741.png" width="530" alt="640">
...
### 1、线索二叉树的结构
<img src="images/9c4822e034026ba5730552cb093b6d4d.png" width="670">
- 存储结构：线索链表
	<img src="images/Pasted%20image%2020260423225836.png" width="320">
- 前序与后续线索二叉树
	<img src="images/Pasted%20image%2020260423230201.png" width="280">

### 2、二叉树的线索化
- 中序线索化：进行中序遍历
<img src="images/Pasted%20image%2020260424101346.png" width="720">
```c
//中序线索化二叉树T 主过程
...
### 3、线索二叉树的遍历
<img src="images/Pasted%20image%2020260424105507.png" width="442">
...
2. 孩子表示法
	...
	- 查找该结点的孩子结点方便
	<img src="images/Pasted%20image%2020260424110452.png" width="240">
3. 孩子兄弟表示法
	- 左孩子+右兄弟
	- 相当于把树->二叉树
		<img src="images/Pasted%20image%2020260424111034.png" width="340">

### 2、树、二叉树、森林的转换
1. 树->二叉树：孩子兄弟表示法⬆
	<img src="images/Pasted%20image%2020260424111626.png" width="480">
2. 森林->二叉树：与树相似，把各树的根结点视为兄弟结点
3. 二叉树->树/森林：逆推导，结果唯一

### 3、树和森林的遍历
<u>对应关系：可以将树和森林转化为二叉树来遍历</u>
<img src="images/Pasted%20image%2020260424112902.png" width="440">
- 树的遍历：与二叉树类似
	- 先根，后根，层次遍历
- 森林的遍历
	- 先序遍历：等同于依次对子树进行先序遍历
...
- **哈夫曼树的构造与性质**
![](images/QQ_1781892152085.png)
- **哈夫曼编码**
	-  前缀编码：编码互相不为前缀，防止译码错误
	-  对于高频次出现的符号，可以使其对应的编码变短来缩短平均编码长度
		<img src="images/Pasted%20image%2020260425102136.png" width="273"><img src="images/Pasted%20image%2020260425110250.png" width="199" alt="139">
...
<img src="images/Pasted%20image%2020260425105335.png" width="710" alt="660">